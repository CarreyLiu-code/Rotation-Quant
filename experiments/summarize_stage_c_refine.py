...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize Stage C refine output directories.")
    parser.add_argument("run_dir", help="Stage C refine output directory.")
...
def main() -> None:
    ...
    markdown = [f"# Stage C Refine Summary: {run_dir.name}", ""]
