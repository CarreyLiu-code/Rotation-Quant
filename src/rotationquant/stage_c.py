...
STAGE_C_STRUCTURED_ATTENTION_SPECS: dict[str, StageCStructuredAttentionSpec] = {
    ...
    "attn_direct_absmax_w4a4_absmax_k4v4": StageCStructuredAttentionSpec(
        ...
        quantize_qkv=True,
        quantize_o=True,
        compute_interpretation="block absmax W4A4 linear fake quant plus absmax K4V4",
    ),
    ...
    "attn_rot_lm_w4a4_hlm_k4v4_h32": StageCStructuredAttentionSpec(
        name="attn_rot_lm_w4a4_hlm_k4v4_h32",
        linear_spec=STAGE_B_LINEAR_SPECS["rot_lm_w4a4"],
        kv_spec_key="hadamard_lm_k4v4_h32",
        value_path="o_proj_absorb",
        quantize_qkv=True,
        quantize_o=True,
        compute_interpretation="rotated LM W4A4 plus head-internal H32 HLM K4V4",
    ),
    "attn_rot_absmax_w4a4_hlm_k4v4": StageCStructuredAttentionSpec(
        ...
        quantize_qkv=True,
        quantize_o=True,
        compute_interpretation="Hadamard-rotated absmax W4A4 linear fake quant plus HLM K4V4",
    ),
    ...
    "attn_rot_lm_w3a3_hlm_k3v3": StageCStructuredAttentionSpec(
        name="attn_rot_lm_w3a3_hlm_k3v3",
        linear_spec=STAGE_B_LINEAR_SPECS["rot_lm_w3a3"],
        kv_spec_key="hadamard_lm_k3v3",
        value_path="o_proj_absorb",
        quantize_qkv=True,
        quantize_o=True,
        compute_interpretation="rotated LM W3A3 plus HLM K3V3 with value rotation absorbed into o_proj",
    ),
    "attn_rot_lm_w2a4_hlm_k2v4": StageCStructuredAttentionSpec(
        name="attn_rot_lm_w2a4_hlm_k2v4",
        linear_spec=STAGE_B_LINEAR_SPECS["rot_lm_w2a4"],
        kv_spec_key="hadamard_lm_k2v4",
        value_path="o_proj_absorb",
        quantize_qkv=True,
        quantize_o=True,
        compute_interpretation="rotated LM W2A4 plus HLM K2V4 failure-boundary method",
    ),
